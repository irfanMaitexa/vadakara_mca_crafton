...
import 'package:crafton/modules/user/booking/booking_screen.dart';
import 'package:crafton/modules/user/profile/edit_profile_screen.dart';
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text('test@gmail.com', style: Theme.of(context).textTheme.headline6),
              Text('+91 9655585485', style: Theme.of(context).textTheme.headline6),
              ...
              ProfileMenuWidget(title: "Booking Details", icon: LineAwesomeIcons.wallet, onPress: () {
