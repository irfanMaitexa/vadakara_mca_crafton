  ...
  Future<void> registerUser(
    ...
    try {
      ...
      , (route) => false);
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to register user: ${jsonDecode(response.body)['Message']}'),
          ),
        );
...
Future<int?> login({required BuildContext context,required String email,required String password}) async {
